...
# -*- coding: utf-8 -*-
"""
Argo10_correct_fixed.py – исправленная версия с правильным критерием успеха.
Успех: после перестановки лента содержит оракульное слово (w).
"""
...
# ------------------------------------------------------------------
# Семантический вектор (без изменений)
# ------------------------------------------------------------------
...
# ------------------------------------------------------------------
# Эволюционирующий оракул (без изменений)
# ------------------------------------------------------------------
...
# ------------------------------------------------------------------
# Мутации и кроссовер (без изменений)
# ------------------------------------------------------------------
...
# ------------------------------------------------------------------
# ArgoMachine (без изменений, кроме исправления опечатки)
# ------------------------------------------------------------------
class ArgoMachine:
    ...
    def evolve_oracles(self) -> None:
        ...
        self.oracle_pool = [o for o in self.oracle_pool if o.fitness >= 0.1 or o.usage_count <= 5]
...
# ------------------------------------------------------------------
# Генерация начального пула (без изменений)
# ------------------------------------------------------------------
...
# ------------------------------------------------------------------
# Запуск одного эксперимента (исправлен)
# ------------------------------------------------------------------
...
# ------------------------------------------------------------------
# Статистика и визуализация (без изменений)
# ------------------------------------------------------------------
...
def main():
    ...
    fig.suptitle(f"Статистика Argo10 (исправленная версия) по {NUM_RUNS} запускам", fontsize=14)
    ax = axes[0, 0]
    ...
    plt.tight_layout()
    plt.savefig('argo10_correct_fixed_results.png', dpi=150, bbox_inches='tight')
    print(f"\nРисунок сохранён как argo10_correct_fixed_results.png")
